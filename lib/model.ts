...
export type AppSnapshot = { version:2; questions:Question[]; progress:Progress; history:ReviewRecord[]; settings:Settings; interviewReports:InterviewReport[] };
...
export const LEARNING_ROUTES=[
  { id:'all',name:'综合面试',description:'覆盖数据库、网络、操作系统与系统设计',categories:[] as string[] },
  { id:'java-backend',name:'Java 后端 30 天',description:'Java、数据库、中间件与系统设计',categories:['Java','数据库','中间件','系统设计'] },
...
export function createSnapshot(questions:Question[],progress:Progress,history:ReviewRecord[],settings:Settings,interviewReports:InterviewReport[]):AppSnapshot {
  return {version:2,questions:questions.map(normalizeQuestion),progress,history,settings:{...DEFAULT_SETTINGS,...settings},interviewReports};
}
